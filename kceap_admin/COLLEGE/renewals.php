...
LEFT JOIN college_renew_documents cd 
                ...
                <table class="table table-bordered table-hover table-striped align-middle">
                    ...
                    <?php if (!empty($renewals)): ?>
                        <?php $i = 1; foreach ($renewals as $r): ?>
                            <?php
                                $rd_sql = "SELECT id, file_name, file_path FROM college_renew_documents WHERE account_id = ? ORDER BY id DESC";
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="text-center text-muted">No renewal requests.</td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
...
<script>
    ...
    function viewRenewal(renewal, docs) {
        ...
        html += '<p><strong>Semester:</strong> ' + (renewal.semester || 'N/A') + '</p>';
