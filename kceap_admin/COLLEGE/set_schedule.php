        ...
        <div class="container">
            <div class="card p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="text-end">
                        <span class="badge bg-info fs-6">Applied: <?= $appliedCount ?> / Limit:
                            <?= $limit ?: 'Unlimited' ?></span>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php if ($result && $result->num_rows > 0): ?>
                                ...
                                while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        <td><?= $i++ ?></td>
                                        <td title="<?= htmlspecialchars($row['firstName']) ?>">
                                            <?= htmlspecialchars($row['firstName']) ?>
                                        </td>
                                        <td title="<?= htmlspecialchars($row['middleName']) ?>">
                                            <?= htmlspecialchars($row['middleName']) ?>
                                        </td>
                                        <td title="<?= htmlspecialchars($row['lastName']) ?>">
                                        ...
                                        <td title="<?= htmlspecialchars($row['yearLevel']) ?>">
                                            <?= htmlspecialchars($row['yearLevel']) ?>
                                        </td>
                                        <td title="<?= htmlspecialchars($row['address']) ?>">
                                            <?= htmlspecialchars($row['address']) ?>
                                        </td>
                                        <td title="<?= htmlspecialchars($row['phoneNumber']) ?>">
                                            <?= htmlspecialchars($row['phoneNumber']) ?>
                                        </td>
                                        <td title="<?= htmlspecialchars($row['emailAddress']) ?>">
                                            <?= htmlspecialchars($row['emailAddress']) ?>
                                        </td>
                                        <td>
                                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#scheduleModal" data-id="<?= $row['id'] ?>"
                                                ...
                                                data-email="<?= htmlspecialchars($row['emailAddress']) ?>">Set</button>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
