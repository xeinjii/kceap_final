...
$sql = "SELECT * FROM highschool_schedule_list ORDER BY schedule_date DESC, schedule_time DESC";
...
<head>
    ...
    <title>Highschool Applicants - KCEAP</title>
        ...
        <script>
            setTimeout(function () {
                ...
                if (alertBox) {
                    ...
                    bsAlert.close(); // Proper Bootstrap close
                }
            }, 3000); // 3 seconds
        </script>
    <?php endif; ?>
            ...
            <div class="card p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="mb-0">
                        ...
                        Scheduled Highschool Applicants
                    </h3>
                </div>
