        ...
        <div class="container">
            <div class="card p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="mb-0"><span
                            class="material-symbols-outlined align-middle me-1 text-primary">refresh</span> Renewal
                        Requests</h3>
                </div>
                            ...
                            <?php if (!empty($renewals)): ?>
                                ...
                                foreach ($renewals as $r): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars(($r['first_name'] ?? '') . ' ' . ($r['last_name'] ?? '')) ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php if (!empty($r_docs)): ?>
                                                <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal"
                                                    ...
                                                    onclick='showDocuments(<?= htmlspecialchars(json_encode($r_docs)); ?>)'>
                                        ...
                                        <td><span
                                                class="badge bg-info text-dark"><?= htmlspecialchars($r['status'] ?? 'pending') ?></span>
                                        </td>
                                        <td class="text-nowrap">
                                            <!-- Accept button -->
                                            <button class="btn btn-success btn-sm me-1"
                                                onclick="confirmAccept(<?= $r['applicant_id'] ?>)">
                                                Accept
                                            </button>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm me-1" data-bs-toggle="modal"
                                                ...
                                                onclick='viewRenewal(<?= json_encode($r, JSON_HEX_APOS | JSON_HEX_QUOT) ?>, <?= json_encode($r_docs, JSON_HEX_APOS | JSON_HEX_QUOT) ?>)'>
                                                View
                                            </button>
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm me-1" data-bs-toggle="modal"
                                                ...
                                                onclick='openMessageModal(<?= json_encode($r, JSON_HEX_APOS | JSON_HEX_QUOT) ?>)'>
                                                Message
                                            </button>
                                        </td>
                ...
                <div class="modal-body">
                    <form id="messageForm" method="POST" action="send_message.php">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="message_body" name="message" rows="6"
