...
LEFT JOIN highschool_documents cd 
    ...
    <div class="container">
        <div class="card p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="mb-0"><span class="material-symbols-outlined align-middle me-1 text-primary">pending</span> Pending Highschool Applicants</h3>
                <div>
                ...
                <table class="table table-bordered table-hover table-striped align-middle">
                    ...
                    <?php if (!empty($pending_applicants)): ?>
                        <?php $i = 1; foreach ($pending_applicants as $applicant): ?>
                            <?php
                                // Fetch uploaded documents for this highschool applicant
                                $doc_sql = "SELECT id, file_name, file_path FROM highschool_documents WHERE account_id = ? ORDER BY id DESC";
...
<script>
    ...
    function viewApplicant(applicant, docs) {
        let html = `
            <div class="row mb-3">
                <div class="col-md-6">
                    <p><strong>Applicant ID:</strong> ${applicant.applicant_id}</p>
    ...
    // handle view dropdown (HS admin) - navigate to HS renewal page
